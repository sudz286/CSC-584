...
{
        public:
        float radiusDeceleration = 100.0, radiusSatisfaction = 2.0, timeToTargetVelocity = 10.0;
...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        if(event.type ==  sf::Event::MouseButtonPressed)
        {
            ...
            sf::Vector2f mouse_final_float = sf::Vector2f(static_cast < float > (mouse_final.x), static_cast < float > (mouse_final.y) );
        ...
        // Breadcrumb logic using double ended queue
